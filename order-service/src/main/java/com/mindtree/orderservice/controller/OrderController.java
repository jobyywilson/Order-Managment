...
import com.mindtree.orderservice.dto.OrderInfoDTO;
...
public class OrderController {
	...
	@PostMapping
	public OrderInfoDTO createOrder(@Valid @RequestBody OrderDTO orderDTO ) {

		return new OrderInfoDTO(orderService.createOrder(orderDTO));
